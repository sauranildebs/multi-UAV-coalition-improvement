%function [t, performance] = mainSimCentralBDA(tarIndex, nTargets)
...
for t = 0:dt:10000
    ...
    for iUav = 1:length(uav)
        ...
        [uav(iUav),target,targetResources,nextBroadcast, endflag] = uavlogicCentral(uav(iUav),target,dt,l,b,targetLocations,targetResources,broadcast,nextBroadcast, endflag, t);
   ...
   % end
    ...
    if targetResources == 0 & endflag == 1
        break
    else
