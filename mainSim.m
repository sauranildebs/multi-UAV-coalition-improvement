function [t, performance] = mainSim(tarIndex, nTargets)
...
[uav,target,l,b] = initializeMonte_v1(tarIndex,nTargets);
...
for t = 0:dt:10000
    ...
    for iUav = 1:length(uav)
        ...
        [uav(iUav),target,targetResources,nextBroadcast] = uavlogic2(uav(iUav),target,dt,l,b,targetLocations,targetResources,broadcast,nextBroadcast);
